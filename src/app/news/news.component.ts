      ...
      <div class="max-w-[1000px] mx-auto">
        ...
        <div class="flex flex-col gap-6">
          ...
          <a [routerLink]="['/news', 'bit-mesra-award']"
             class="order-0 group block no-underline bg-[#0d1f3c] border border-[#2563EB]/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:-translate-y-1 hover:bg-[#112244] hover:shadow-[0_10px_30px_rgba(37,99,235,0.15)] backdrop-blur-sm">
            <p class="text-[#2563EB] text-xs uppercase tracking-widest font-semibold mb-3">August 31, 2026</p>
            ...
            <p class="text-white/90 text-sm md:text-base leading-relaxed mb-4">
              Electronics and Communication Engineering alumna honored for contributions to engineering, technology and entrepreneurship at BIT Mesra&#8217;s 72nd Foundation Day.
            </p>
          ...
          <a *ngFor="let item of news"
             ...
             class="order-3 group block no-underline bg-[#0d1f3c] border border-[#2563EB]/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:-translate-y-1 hover:bg-[#112244] hover:shadow-[0_10px_30px_rgba(37,99,235,0.15)] backdrop-blur-sm">
